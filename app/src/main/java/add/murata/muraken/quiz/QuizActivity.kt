...
class QuizActivity : AppCompatActivity() {
    ...
    val quizList: List<List<String>> = listOf(
            ...
            listOf("Android", "JavaScript", "Kotlin", "Swift", "Kotlin"),
            listOf("ImageView", "文字", "音声", "画像", "画像")
    )
    val shuffledList: List<List<String>> = quizList.shuffled()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        correntAnswerText.isVisible = false
        ...
        fun showAnswer() {
            ...
            correntAnswerText.isVisible = true
